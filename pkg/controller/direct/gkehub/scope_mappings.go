...
func GKEHubScopeSpec_ToAPI(mapCtx *direct.MapContext, in *krm.GKEHubScopeSpec, labels map[string]string) *featureapi.Scope {
	if in == nil {
		return nil
	}
	out := &featureapi.Scope{}
	out.Labels = labels
	out.NamespaceLabels = in.NamespaceLabels
	return out
}

func GKEHubScopeStatus_FromAPI(mapCtx *direct.MapContext, in *featureapi.Scope) *krm.GKEHubScopeStatus {
	if in == nil {
		return nil
	}
...
func ScopeLifecycleStateStatus_FromAPI(mapCtx *direct.MapContext, in *featureapi.ScopeLifecycleState) *krm.ScopeLifecycleStateStatus {
	if in == nil {
		return nil
	}
